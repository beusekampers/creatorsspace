...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        $this->get('l/login', 'Auth\LoginController@showLoginForm')->name('login');
        $this->post('l/login', 'Auth\LoginController@login');
        $this->post('l/logout', 'Auth\LoginController@logout')->name('logout');

        // Registration Routes...
        $this->get('r/register', 'Auth\RegisterController@showRegistrationForm')->name('register');
        $this->post('r/register', 'Auth\RegisterController@register');
