                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('personal_text') ? ' has-error ' : '' }}">
                            <label for="personal_text" class="col-md-4 control-label">Personal text</label>

                            <div class="col-md-6">
                                <input id="personal_text" type="text" class="form-control" name="personal_text" required>

                                @if ($errors->has('personal_text'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('personal_text') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
